...
/* Chart container — fixed size, seats.io handles all zooming internally */
...
/* seats.io renders here — fixed dimensions, no CSS transform zoom */
#sm-full{width:100%;height:100%;min-height:550px}
    ...
    <div class="sm-modal" onclick="event.stopPropagation()">
        ...
        <div class="sm-zoom-hint" id="smZoomHint">
            <span>
                ...
                Scroll to zoom · Click a section to zoom in · Pinch on mobile
            </span>
        ...
        loadSDK(function () {
            new seatsio.SeatingChart({
                ...
                onChartRendered: function (chart) {
                    ...
                    /* Wire Reset View button to seats.io native resetView() */
